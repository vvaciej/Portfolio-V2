			...
			{params.lang === 'pl' || params.lang === 'en' ? (
				<div className='bg-[#1c1c1e] h-max w-full text-black'>
					...
					<Header />
						...
						<main className='xl:w-[70rem] md:w-[44rem] xs:w-[22rem] xxs:w-[18rem] w-[91%] sm:w-[30rem] lg:w-[60rem] mt-10 lg:mt-16 h-max md:max-h-[85rem] sm:max-h-[130rem] max-h-[190rem] xl:max-h-[70rem] grid md:grid-cols-3 grid-cols-2 lg:grid-cols-4 lg:grid-rows-4 sm:grid-rows-8 grid-rows-[repeat(16,minmax(0,1fr))] md:grid-rows-6 gap-5 md:mb-32 mb-20'>
							<AboutMeBlock />
							<ImgCarousel />
							<LearningPath />
